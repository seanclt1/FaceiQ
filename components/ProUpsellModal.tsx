...
const ProUpsellModal: React.FC<ProUpsellModalProps> = ({ onClose, onSubscribe }) => {
      ...
      <div className="w-full max-w-md bg-[#1C1C1E] border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl relative animate-slide-up my-auto">
        ...
        <div className="relative h-80 flex bg-zinc-900">
            ...
            <div className="relative w-1/2 h-full overflow-hidden group">
                ...
                <img 
                    src="https://images.unsplash.com/photo-1618077360395-f3068be8e001?auto=format&fit=crop&w=500&q=80" 
                    className="w-full h-full object-cover object-center brightness-[0.75] contrast-[0.8] saturate-[0.5] sepia-[0.3] scale-x-[1.2] scale-y-[0.95] origin-center blur-[0.5px]"
                    alt="Before"
                />
                {/* Muddy/Yellow tint for 'bad skin/lighting' effect */}
                <div className="absolute inset-0 bg-yellow-900/30 mix-blend-multiply"></div>
                {/* Irritated skin simulation via overlay */}
            ...
            <div className="relative w-1/2 h-full overflow-hidden">
                <img 
                    src="https://images.unsplash.com/photo-1618077360395-f3068be8e001?auto=format&fit=crop&w=500&q=80" 
                    className="w-full h-full object-cover object-center scale-105 contrast-[1.15] brightness-110 saturate-[1.1]"
                    alt="After"
                />
                {/* Cool blue/purple tint for 'Chad' effect */}
                <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/20 via-transparent to-indigo-500/20 mix-blend-overlay"></div>
            </div>
            ...
            <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-[#1C1C1E] via-[#1C1C1E]/95 to-transparent px-6 pb-2 pt-24 z-30 flex justify-start">
                <h2 className="text-3xl font-extrabold text-white tracking-tight leading-none drop-shadow-xl text-left max-w-[85%]">
                    Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">10/10 GOD</span>
                </h2>
            </div>
        </div>
